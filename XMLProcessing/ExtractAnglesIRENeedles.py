...
df2 = df1.drop_duplicates(['LateralError'], keep='last') #residual error, longitudinal err, doesn't matter. we just want to remove the duplicates
# TO DO: better method for droping duplicates
...
filename = 'IRE_NeedleInformationv1_' + timestr + '.xlsx' 
